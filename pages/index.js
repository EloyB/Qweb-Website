      ...
      <div className="h-screen max-w-screen-xl m-auto">
        <div className="pt-20 pb-32 px-10 sm:px-20 relative z-20">
          ...
          <h1 className="font-extrabold text-3xl text-secondary mb-3 sm:text-4xl md:text-5xl md:leading-tight lg:text-6xl xl:text-7xl">
            Launch your business to the <span className="text-primary">world wide web</span>
          </h1>
        ...
        <div className="absolute px-5 bottom-20 w-full max-w-2xl transform left-1/2 -translate-x-1/2 sm:w-3/4 md:left-auto md:right-0 md:-translate-x-px md:bottom-10 xl:right-40">
          <TopIllustration />
        </div>
      </div>
