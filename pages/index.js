  ...
  return (
    <div>
      ...
      <div className='h-screen max-w-screen-xl m-auto'>
        <div className='pt-20 pb-32 px-10 sm:px-20 relative z-20'>
          ...
          <h1 className='font-extrabold text-3xl text-secondary mb-3 sm:text-4xl md:text-5xl md:leading-tight lg:text-6xl xl:text-7xl'>
            Launch your business to the{' '}
            <span className='text-primary'>world wide web</span>
          </h1>
      ...
      <div id='launch' className='bg-secondary w-full pt-24 pb-24'>
        <div className='px-10 text-center relative sm:px-20'>
          ...
          <p className='text-white font-light text-base mt-4 pb-24 max-w-screen-sm m-auto lg:text-xl'>
            A Belgian based company with an expertise in web design. Designing
            and developing your websites.
          </p>
      ...
      <div className='bg-secondary pt-24'>
        ...
        <div className='pt-40 pb-10 px-8 md:flex lg:max-w-screen-xl lg:m-auto'>
          <div className='w-full md:pr-8'>
            ...
            <p className='text-white text-center font-light md:text-left'>
              Feel free to ask all your question or follow us on social media to
              keep updated about out work
            </p>
          </div>
        ...
        <div className='mx-8 md:px-8 md:flex lg:max-w-screen-xl lg:m-auto border-t-2 border-secondary-light py-10 flex items-center justify-between'>
          <div>
          ...
          <div className='flex space-x-3 md:space-x-7 items-center'>
            <a target='_blank' href='https://www.instagram.com/qwebdesign_be/'>
              <svg
                viewBox='0 0 24 24'
                xmlns='http://www.w3.org/2000/svg'
                fill='currentColor'
